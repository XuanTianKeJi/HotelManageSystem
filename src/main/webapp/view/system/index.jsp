    ...
    <div class="layui-layout layui-layout-admin">
      <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
          ...
          <li class="layui-nav-item" lay-unselect>
            <a href="javascript:;">
              <cite>${loginEmployee.employeeName }</cite>
            </a>
            <dl class="layui-nav-child">
              <dd><a lay-href="set/user/info.html">基本资料</a></dd>
              <dd><a lay-href="set/user/password.html">修改密码</a></dd>
              <hr>
              <dd  style="text-align: center;"><a href="${pageContext.request.contextPath}/system/login">退出</a></dd>
            </dl>
          </li>
        ...
        <div class="layui-side-scroll">
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            ...
            <li data-name="component" class="layui-nav-item">
              <a href="javascript:;" lay-tips="房间管理" lay-direction="2">
            ...
            <li data-name="user" class="layui-nav-item">
              <a href="javascript:;" lay-tips="工作人员管理" lay-direction="2">
